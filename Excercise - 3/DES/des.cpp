...
string stringtobin(string word)
{
	string bin = "";
	for (char &_char : word)
	{
...
string binaryToString(const string &binaryCipherText)
{
	string text = "";

	for (size_t i = 0; i < binaryCipherText.length(); i += 8)
	{
		string byte = binaryCipherText.substr(i, 8);
...
int main()
{
	...
	cout << "Enter a 64-bit plain text : ";
	cin >> pt;
